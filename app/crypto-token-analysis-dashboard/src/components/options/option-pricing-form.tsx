...
const formSchema = z.object({
  ...
  volatility_model: z.nativeEnum(VolatilityModel).optional(),
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="volatility_model">Volatility Model</Label>
                <Select 
                  onValueChange={(value) => setValue('volatility_model', value as VolatilityModel)}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select model" />
                  </SelectTrigger>
