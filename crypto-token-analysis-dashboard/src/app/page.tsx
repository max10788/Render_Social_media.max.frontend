...
function DashboardPage() {
  ...
  useEffect(() => {
    if (simulationProgress === 1) { // 100% complete
      toast({
        title: 'Simulation Complete',
        description: `Simulation ${simulationId} has finished processing.`,
      });
    }
  }, [simulationProgress, simulationId, toast]);

  // Reset pricing when leaving pricing tab
  useEffect(() => {
    if (activeTab !== 'pricing' && pricingStatus !== 'idle') {
      resetPricing();
    }
  }, [activeTab, pricingStatus, resetPricing]);
