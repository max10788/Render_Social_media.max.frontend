...
export const API_CONFIG = {
  ...
  // 🆕 OTC ANALYSIS ENDPOINTS - COMPLETE
  OTC_DESKS: `/api/otc/desks`,
  OTC_DESKS_DISCOVER: `/api/otc/desks/discover`,
  OTC_WALLET_PROFILE: (address) => `/api/otc/wallet/${address}/profile`,
  OTC_WALLET_DETAILS: (address) => `/api/otc/wallet/${address}/details`,
  OTC_STATISTICS: `/api/otc/statistics`,
  OTC_DISTRIBUTIONS: `/api/otc/analytics/distributions`,
  OTC_NETWORK_GRAPH: `/api/otc/network/graph`,
  OTC_HEATMAP: `/api/otc/network/heatmap`,
  OTC_FLOW_TRACE: `/api/otc/flow/trace`,
  OTC_SANKEY: `/api/otc/flow/sankey`,
  OTC_TIMELINE: `/api/otc/flow/transfers/timeline`,
  OTC_WATCHLIST: `/api/otc/monitoring/watchlist`,
  OTC_WATCHLIST_ADD: `/api/otc/monitoring/watchlist/add`,
  OTC_WATCHLIST_REMOVE: (address) => `/api/otc/monitoring/watchlist/${address}`,
  OTC_ALERTS: `/api/otc/monitoring/alerts`,
  OTC_ALERTS_CREATE: `/api/otc/monitoring/alerts/create`,
  OTC_ALERTS_DISMISS: (alertId) => `/api/otc/monitoring/alerts/${alertId}/dismiss`,
  OTC_STREAMS_STATUS: `/api/otc/streams/status`,
  OTC_STREAMS_TEST: `/api/otc/streams/test`,
  OTC_SYSTEM_HEALTH: `/api/otc/admin/system/health`,
  OTC_DATABASE_STATUS: `/api/otc/admin/database/status`,
  OTC_SETUP_STREAMS: `/api/otc/admin/setup-moralis-streams`,
